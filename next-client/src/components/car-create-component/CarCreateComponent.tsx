...
const CarCreateComponent = () => {
  ...
  console.log('newCar.price:', newCar.price);

  if (!exchangeRates || isNaN(newCar.price) || !newCar.currency) {
    console.log('Invalid data. Returning default values.');
  ...
  console.log('Converted prices:', result);
  return result;
    ...
    <section className={styles.createCarSection}>
      ...
      <form className={styles.createCarForm} onSubmit={handleCreateCar}>
        ...
        <select name="currency" value={newCar.currency} onChange={handleInputChange}>
          ...
          <input type="number" name="max_speed" value={newCar.max_speed} placeholder="Max Speed"
                 onChange={handleInputChange}/>
          <input type="number" name="seats_count" value={newCar.seats_count} placeholder="Seats Count"
                 onChange={handleInputChange}/>
          <input type="number" name="engine_volume" value={newCar.engine_volume} placeholder="Engine Volume"
                 onChange={handleInputChange}/>
          <label>
              Air Conditioner:
